...
/* Custom instructions for gem5 exercise */
#define MATCH_MAXX 0x000b
#define MASK_MAXX  0xfe00707f
/* 
   funct3 = 0b000       // 0
   funct7 = 0b0000000   // 0
   opcode = 0b0001011   // 0xb
   MATCH_MAXX = (funct7 << 25) | (funct3 << 12) | opcode
              = (0x0 << 25) | (0x0 << 12)  | 0xb
              = 0x0000000b
   MASK_MAXX = (0x7f << 25) | (0x7 << 12) | 0x7f
              = 0xfe00707f
   
*/
#define MATCH_MINX 0x100b
#define MASK_MINX  0xfe00707f
/* 
   funct3 = 0b001       // 1
   funct7 = 0b0000000   // 0
   opcode = 0b0001011   // 0xb
   MATCH_MINX = (funct7 << 25) | (funct3 << 12) | opcode
              = (0x0 << 25) | (0x1 << 12)  | 0xb
              = 0x0000100b
   MASK_MINX = (0x7f << 25) | (0x7 << 12) | 0x7f
              = 0xfe00707f
...
#ifdef DECLARE_INSN
/* Custom instructions for gem5 exercise */
DECLARE_INSN(maxx, MATCH_MAXX, MASK_MAXX)
DECLARE_INSN(minx, MATCH_MINX, MASK_MINX)
